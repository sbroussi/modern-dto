...
import com.sbroussi.soa.SoaDtoRequestFactory;
...
public class App1 {
    ...
    private SoaDtoRequestFactory soaRequestFactory = new SoaDtoRequestFactory(getSoaContext());
    ...
    public SoaDtoRequest sendText(final String text) {
        ...
        // send message
        SoaDtoRequest request = soaRequestFactory.create(adrvirtu);
