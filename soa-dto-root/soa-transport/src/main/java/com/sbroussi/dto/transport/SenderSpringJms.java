 ...
 */
@Slf4j
public class SenderSpringJms implements MessageSender {
     ...
     */
    public SenderSpringJms(final JmsTemplate jmsTemplate,
    ...
    private String sendMessage(final boolean isOneWayRequest,
        ...
        throw new TransportException("TODO: read response with Spring-JMS and timeout [" + timeout + "]");
    ...
    private String sendMessage(final Queue requestQueue,
        ...
        try {
            ...
            throw new TransportException("cannot send JMS message [" + message + "]", e);
        }
